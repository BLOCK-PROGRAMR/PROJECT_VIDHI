...
const voucherRoutes = require("./routers/voucherRoutes.js");
...
const corsOptions = {
  origin: process.env.NODE_ENV === 'production'
    ? ['https://projectvidy-frontend.onrender.com', process.env.FRONTEND_URL || '*']
    : 'http://localhost:5173' || 'http://localhost:5174',
  credentials: true,
  methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
  allowedHeaders: ['Content-Type', 'Authorization', 'is-second-add'] // ✅ add this
};
